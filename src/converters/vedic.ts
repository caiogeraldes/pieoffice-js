function hk_deva(input: string): string {
...
function hk_iast(input: string): string {
...
function hk_iso(input: string): string {
    input = input.replace(/A/g, "ā");
    input = input.replace(/I/g, "ī");
    input = input.replace(/U/g, "ū");
...
function hkUdToHkAnu(hkUdStr: string): string {
    const hkSyllab = hkToSyllables(hkUdStr);
    const hkAcc = hkAccentuation(hkSyllab);

    const hkSyllabArray: string[] = hkSyllab.split(".");
...
function udToAnu(udStr: string): string {
...
function hkToSyllables(hkStr: string): string {
    let hkSyllab: string = hkStr;
...
function hkAccentuation(hkSyllab: string): string {
    let hkAcc: string[] = hkSyllab.split(".");
